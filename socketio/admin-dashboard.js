const { combineStringObjectArray } = require('../functions/object');
...
async function getPreviewContent(data, socket) {
    ...
    // console.log('- - - - - - GET PREVIEW CONTENT - DATA - - - - - -');
    // console.log(data);
    ...
    try {
        ...
        // console.log('- - - - - - GET PREVIEW CONTENT - EVENT - - - - - -');
        // console.log(event);
...
async function sendSetupContent(data) {
    ...
    if (action == 'back') {
        ...
        /*console.log(setup.data.split('{|,|}'));
        let dataArray = setup?.data?.split('{|,|}');
        dataArray.pop();
        let oldPair = dataArray.pop();
        let dataString = '';
        dataArray.forEach((dataPair) => {
            dataString += `${dataPair}{|,|}`;
        });
        console.log(setup.data);
        ...
        setup.tempData += `${oldPair}{|,|}`;
        setup.data = dataString;*/
    }
    ...
    // console.log('- - - - - - - - SEND CSS - SETUP.TYPE - - - - - - - -');
