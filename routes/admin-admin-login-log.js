...
const SITE_NAME = 'admin/admin-login-log';
const FILE_NAME = 'admin-admin-login-log';
...
router.patch(`/${SITE_NAME}/:id`, ensureAuthenticated, getAdminLoginLog, async (req, res) => {
...
router.delete(`/${SITE_NAME}/:id`, ensureAuthenticated, getAdminLoginLog, async (req, res) => {
