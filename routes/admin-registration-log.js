...
const SITE_NAME = 'admin/registration-log';
const FILE_NAME = 'admin-registration-log';
...
router.patch(`/${SITE_NAME}/:id`, ensureAuthenticated, getRegistrationLog, async (req, res) => {
...
router.delete(`/${SITE_NAME}/:id`, ensureAuthenticated, getRegistrationLog, async (req, res) => {
