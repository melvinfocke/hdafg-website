...
router.patch(`/admin/${SITE_NAME}/:id`, ensureAuthenticated, getAdmin, async (req, res) => {
    let admin = res.admin;
...
router.delete(`/admin/${SITE_NAME}/:id`, ensureAuthenticated, getAdmin, async (req, res) => {
