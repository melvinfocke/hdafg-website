const url = `/admin/registration-log`;
...
function editbutton(id) {
    if (buttonState.localeCompare('E') == 0) {
        ...
        contentArr.forEach((item, index) => {
            switch (index) {
                case 0:
                    data.lastRegistrationAsString = item;
                    break;
                case 1:
                    data.amountOfRegistrations = item;
                    break;
            }
        });
